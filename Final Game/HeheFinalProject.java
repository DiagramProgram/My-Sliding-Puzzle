...
public class HeheFinalProject extends Applet implements ActionListener {
  Panel p_card;
  ...
  public void actionPerformed (ActionEvent e) {
    ...
    if (e.getActionCommand().equals((pos1-1) + "" + pos2) || e.getActionCommand().equals(pos1 + "" + (pos2-1)) || e.getActionCommand().equals((pos1+1) + "" + pos2) || e.getActionCommand().equals(pos1 + "" + (pos2+1))) {
      moves++;
    ...
    if (e.getActionCommand().equals((pos3-1) + "" + pos4) || e.getActionCommand().equals(pos3 + "" + (pos4-1)) || e.getActionCommand().equals((pos3+1) + "" + pos4) || e.getActionCommand().equals(pos3 + "" + (pos4+1))) {
      String pos = (e.getActionCommand());
    ...
    if (e.getActionCommand().equals((pos5-1) + "" + pos6) || e.getActionCommand().equals(pos5 + "" + (pos6-1)) || e.getActionCommand().equals((pos5+1) + "" + pos6) || e.getActionCommand().equals(pos5 + "" + (pos6+1))) {
      String pos = (e.getActionCommand());
      int i = (int) (pos.charAt(0)-48);
      int j = (int) (pos.charAt(1)-48);
